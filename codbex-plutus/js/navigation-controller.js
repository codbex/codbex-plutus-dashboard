const navigation = angular.module('launchpad', [
	'ngResource',
	'ideLayout',
	'ideUI',
]);
navigation.controller('LaunchpadViewController', [
	'$scope',
	'messageHub',
	'$http',
	function ($scope, messageHub, $http) {
		...
		$http
			.get(
				'/services/ts/codbex-plutus/api/NavigationExtension/NavigationService.ts'
			)
			.then(function (response) {
				...
				$scope.groupItems.forEach((e) =>
					e.sort((a, b) => a.orderNumber - b.orderNumber)
				);
			})
